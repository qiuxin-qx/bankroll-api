 ...
 */
@Entity
@Table(name = "bk_homs_history_realdeal_record")
@AttributeOverride(name = "id", column = @Column(name = "realdeal_id"))
public class HomsHistoryRealdealRecord extends Model implements Serializable {
	private static final long serialVersionUID = 7114685299536449481L;
